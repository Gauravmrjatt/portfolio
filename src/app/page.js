...
const items = [
  {
    ...
    </svg>, color: 'insta', label: 'Instagram', href: "https://www.instagram.com/gauravmrjatt"
  },
  {
    ...
    </svg>, color: 'github', label: 'Github', href: "https://github.com/Gauravmrjatt"
  },
  {
    icon: <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
    ...
    </svg>, color: 'linkedin', label: 'LinkedIn', href: "https://www.linkedin.com/in/gauravmrjatt"
  },
  {
    icon: <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
    ...
    </svg>, color: 'telegram', label: 'Telegram', href: "https://telegram.dog/gauravmrjatt"
  },
];
  ...
  return (
    <>
      <div>
        ...
        {/* main hero section */}
        <div className="flex min-h-[100vh] flex-col-reverse  md:flex-row items-center justify-evenly " >
          ...
          <div className="w-full md:w-1/2 md:h-full ">
            <img className="" src="https://static.vecteezy.com/system/resources/previews/011/490/381/non_2x/happy-smiling-young-man-avatar-3d-portrait-of-a-man-cartoon-character-people-illustration-isolated-on-white-background-vector.jpg" />
          </div>
        </div>
        ...
        <div className="mt-9 relative">
          ...
          <div className="flex flex-wrap items-center ">
            ...
            {/* Text section */}
            <div className="w-full md:w-1/2 p-4 font-sans text-base md:text-lg font-200 leading-relaxed -mt-[25vh] md:mt-0">
